    ...
    const options = {
      reply_markup: {
        inline_keyboard: [
          ...
          [{ text: 'ул. Рубинштейна д.23', callback_data: 'rub23' }]
...
function showApartmentMenuRub23(chatId) {
  ...
  bot.sendMessage(chatId, 'ул. Рубинштейна д.23 \nВыберите необходимый пункт меню:', options);
};
